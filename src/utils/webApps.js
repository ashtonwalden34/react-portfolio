export default [
    {
        ...
        "description": "A progressive web application that allows the user to track their finances with or without an internet connection through data caching.",
    ...
    },
    {
        "id": 4,
        "title": "Day Planner",
        "description": "A simple scheduler app designed to help the user track tasks hour by hour by allowing them to create, save, edit, and delete tasks as well as color coding the task based on the current time of day.",
    ...
    },
    {
        ...
        "description": "A node based app designed to build an html page of team members based on user input. To run simply enter 'node prompt.js' after all dependencies have been installed.",
    ...
    },
    {
        "id": 7,
        "title": "Burger Logger",
        "description": "An app constructed using handlebars that allows the user to input the name of a burger and select if they would like it to be devoured or not.",
    ...
    },
    {
        ...
        "description": "An application that allows the user to search for a city and through API calls it will provide them with the current weather and UV index as well as a five day forecast.",
    ...
    },
    {
        ...
        "description": "A node based application that allows the user to create, update, view, and delete an employee database that contains three separate tables, departments, roles, and employees.",
